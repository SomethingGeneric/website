...
## Personal Views
The opinions expressed on this site belong solely to me, Matt Compton. They do **not** represent the views of my past, present, or future employers, clients, or collaborators. Take everything here (and on the internet generally) with a grain of salt. Do your own research, think critically, ask people you trust, etc. I'm not a doctor, lawyer, or anyone else who can or should give you advice in a legally binding capacity. (And by the way, neither is any LLM tool, no matter what Big Tech might tell you.)
...
## Browser Support
Pages are rendered statically and should degrade gracefully when JavaScript is disabled. However, a JavaScript-free experience is not formally tested or supported; interactive features (for example, form submissions) may require JavaScript enabled for full functionality.
